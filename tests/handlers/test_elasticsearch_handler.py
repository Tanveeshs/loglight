...
def test_elasticsearch_handler_emit_success():
    handler = ElasticsearchHandler(es_url="http://localhost:9200", index_name="test-index")
...
def test_elasticsearch_handler_custom_url_and_index():
    handler = ElasticsearchHandler(es_url="https://es.example.com:9200", index_name="my-logs")
...
def test_elasticsearch_handler_internal_logging_disabled():
    handler = ElasticsearchHandler(es_url="http://localhost:9200", index_name="test-index", enable_internal_logging=False)
